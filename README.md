## 🖥️ BlueLemon - 황찬영
#### ※ 4명이서 완성한 소셜 네트워크 서비스 사이트로 전체적인 웹의 흐름을 이해하고자 진행한 팀 프로젝트입니다..  <br>
#### ※ 팀 프로젝트로 1차 완성후 배포 및 유지보수를 진행하여 2차 완성한 결과물입니다.
#### ※ 프로젝트 기간 : 2023/06 ~ 2023/07
#### ※ 유지보수 및 배포 기간 : 2024/01 ~ 2024/05
...
### 💡  2. 정확히 이해하지 못한 상태에서 작성하는 코드는 문제를 발생시킴.
- JSP + JSTL에서 HTML + Thymeleaf로 템플릿을 전환하는 과정에서 Thymeleaf에 대해 충분히 공부하지 않고 바로 적용 시키다보니 시간이
  많이 지체되었습니다.
  - URL 처리 방식이나 변수표현, 리터럴에 대해서 정확하게 알지 못하고 사용하여 에러남.
  - 서버 사이드 렌더링에 대해서 잘 모르고 사용하여 의도에 맞지않는 div 태그 생성됨.
  <br> <br>
- 코드를 빠르게 완성하려다 보면 중요한 기본 개념이나 동작 원리를 놓치기 쉬운데, <br>
  이를 깨닫고 나서부터는 내가 모르는 것을 파악하고 인정하며 배우려는 자세를 가지게 되었습니다.
